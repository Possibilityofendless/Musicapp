...
import { ArrowLeft, Settings, Zap, Edit3, AlertCircle } from "lucide-react";
...
export function ProjectEditor({ projectId, onBack }: ProjectEditorProps) {
  const { currentProject, scenes, loadProject, loadScenes, updateProject, generateVideo } = useStore();
